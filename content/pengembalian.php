                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($queryPinjam)) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="?pg=tambah-pengembalian&detail=<?php echo $row['id'] ?>" class="btn btn-sm btn-outline-success">Detail</a>
                                        <!-- <a onclick="return confirm('apakah anda yakin akan menghapus data ini?')" -->
                                            <!-- href="?pg=tambah-pengembalian&delete=<?php echo $row['id'] ?>" class="btn btn-sm btn-outline-danger">Delete</a> -->
                                    </td>
                                </tr>
                            <?php endwhile ?>
                        </tbody>
